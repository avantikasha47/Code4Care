...
function isOptionalNullable(type) {
  return type.startsWith('Optional<Nullable<') || type.startsWith('Nullable<Optional<');
}
export { arrayEntries, coerceNumericStringToNumber, coerceStringOrNumberToBigInt, createSymmetricSchema, identityFn, isNullOrMissing, isNumericString, isOptionalNullable, literalToString, objectEntries, objectKeyEncode, omitKeysFromObject, once, toValidator };